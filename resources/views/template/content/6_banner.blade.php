<!-- Section Sub Banner -->
<section id="weddingSubBanner" class="wedding-sub-banner">
    <div class="wedding-sub-banner-overlay"></div>
    <div class="content">
        <!-- Shape SVG TOP -->
        <div class="wedding-sub-banner-svg-top elementor-shape elementor-shape-top" data-negative="false">
        ...
        <!-- Banner Content -->
        <div class="container text-center wedding-sub-banner-content">
            <div class="row justify-content-md-center">
                <div class="col-md-8">
                    <!-- Name -->
                    <h2 class="wedding-sub-banner-title" data-aos="fade-up" data-aos-duration="1000">“The highest happiness on earth is the happiness of marriage.”</h2>
                    <h2 class="wedding-sub-banner-person" data-aos="fade-up" data-aos-duration="1000">William Lyon Phelps</h2>
                    <!-- ./ Name -->
                </div>
            </div>
        </div>
        ...
        <!-- Shape SVG Bottom -->
        <div class="wedding-sub-banner-svg-bottom elementor-shape elementor-shape-bottom" data-negative="false">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 100" preserveAspectRatio="none">
                <path class="elementor-shape-fill" opacity="0.33"
                      d="M473,67.3c-203.9,88.3-263.1-34-320.3,0C66,119.1,0,59.7,0,59.7V0h1000v59.7 c0,0-62.1,26.1-94.9,29.3c-32.8,3.3-62.8-12.3-75.8-22.1C806,49.6,745.3,8.7,694.9,4.7S492.4,59,473,67.3z"></path>
                <path class="elementor-shape-fill" opacity="0.66"
